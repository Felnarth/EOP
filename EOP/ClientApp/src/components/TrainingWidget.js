...
import { Card, CardContent, CardHeader, FormControl, IconButton, Typography, AppBar, Tabs, Tab, Box, TextField, Grid, Button } from '@material-ui/core';
    ...
    return (
        <form onSubmit={handleSubmit} className={classes.root}>
            ...
            <SearchBar
                ...
                style={{ height: "10%" }}
            />
            <DataGrid rows={rows} columns={columns} pageSize={5} className={classes.gridRootHistory} />
        </form>
    );
};
